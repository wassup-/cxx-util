#ifndef CXX_UTIL_DELEGATE_HPP
#define CXX_UTIL_DELEGATE_HPP

/**
 * source: https://codereview.stackexchange.com/questions/14730/impossibly-fast-delegate-in-c11
 */
...
namespace std
{
  ...
  struct hash<::functional::delegate<R (A...)> >
  {
    size_t operator()(::functional::delegate<R (A...)> const& d) const noexcept
    {
      auto const seed(hash<void*>()(d.object_ptr_));

      return hash<typename ::functional::delegate<R (A...)>::stub_ptr_type>()(
        d.stub_ptr_) + 0x9e3779b9 + (seed << 6) + (seed >> 2);
    }
  };
}

#endif // CXX_UTIL_DELEGATE_HPP
